...
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_BILLBOARD_MODE;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_DISPLAY_CONTEXT;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_ITEM;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_ITEM_LEN;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_LINE_WIDTH;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_TEXT_BACKGROUND;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_POSE;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_STAND_FLAGS;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_TEXT_OPACITY;
import static com.jhuanglululu.billboard.runtime.SyncWasm.GET_YAW;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SCRATCH;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_BILLBOARD_MODE;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_BLOCK;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_DISPLAY_CONTEXT;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_EQUIPMENT;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_ITEM;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_LINE_WIDTH;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_POSE;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_POSITION;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_ROTATION;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_SCALE;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_STAND_FLAGS;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_TEXT;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_TEXT_OPACITY;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SET_YAW;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SPAWN_ARMOR_STAND;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SPAWN_BLOCK_DISPLAY;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SPAWN_ITEM;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SPAWN_ITEM_DISPLAY;
import static com.jhuanglululu.billboard.runtime.SyncWasm.SPAWN_TEXT_DISPLAY;
...
class EntityKindsTest {
    ...
    void everyKindReachesTheRendererWithItsOwnSpawnCall() {
        ...
        SyncRun.rendered(spawnAllKinds(), renderer).assertFinished();
    ...
    void textAttributesRoundTripThroughTheRegistry() {
        ...
        SyncRun.Result result = SyncRun.rendered(main, renderer);
    ...
    void displayContextBeyondFixedStillKills() {
        ...
        SyncRun.run(main).assertKilled("set_display_context", "display context 9 out of range 0..8");
    }
    ...
    void textDisplaysStartFromTheVanillaDefaults() {
        ...
        assertEquals("AYC", SyncRun.run(main).assertFinished().trace());
    }
    ...
    void setTextOnABlockDisplayKills() {
        ...
        SyncRun.run(main).assertKilled("set_text", "is a block display", "text displays");
    }
    ...
    void setBlockOnATextDisplayKills() {
        ...
        SyncRun.run(main).assertKilled("set_block", "is a text display", "block displays");
    }
    ...
    void setItemOnAnArmorStandKills() {
        ...
        SyncRun.run(main).assertKilled("set_item", "is an armor stand");
    }
    ...
    void poseOnAnItemDisplayKills() {
        ...
        SyncRun.run(main).assertKilled("set_pose", "is an item display", "armor stands");
    }
    ...
    void yawOnADisplayKills() {
        ...
        SyncRun.run(main).assertKilled("set_yaw", "is a block display", "armor stands");
    }
    ...
    void rotationOnAnArmorStandKills() {
        ...
        SyncRun.run(main).assertKilled("set_rotation", "is an armor stand", "display entities");
    }
    ...
    void scaleOnAnItemEntityKills() {
        ...
        SyncRun.run(main).assertKilled("set_scale", "is an item entity", "display entities");
    }
    ...
    void displayContextOnATextDisplayKills() {
        ...
        SyncRun.run(main).assertKilled("set_display_context", "is a text display");
    }
    ...
    void billboardModeOnAnArmorStandKills() {
        ...
        SyncRun.run(main).assertKilled("set_billboard_mode", "is an armor stand");
    }
    ...
    void getterOnTheWrongKindKillsToo() {
        ...
        SyncRun.run(main).assertKilled("get_display_context", "is a block display");
    }
    ...
    void poseParkOutOfRangeKills() {
        ...
        SyncRun.run(main).assertKilled("set_pose", "pose part 6 out of range 0..5");
    }
    ...
    void equipmentSlotOutOfRangeKills() {
        ...
        SyncRun.run(main).assertKilled("set_equipment", "slot 6 out of range 0..5");
    }
    ...
    void billboardModeOutOfRangeKills() {
        ...
        SyncRun.run(main).assertKilled("set_billboard_mode", "billboard mode 4 out of range 0..3");
    }
    ...
    void textOpacityOutOfRangeKills() {
        ...
        SyncRun.run(main).assertKilled("set_text_opacity", "opacity 256 out of range 0..255");
    }
    ...
    void invalidItemKills() {
        ...
        SyncRun.validated(main, rejectItems).assertKilled("invalid item \"A\"");
    }
    ...
    void invalidTextKills() {
        ...
        SyncRun.validated(main, rejectText).assertKilled("invalid MiniMessage text \"A\"");
    }
}
